...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="lte/custom/icon/font-class/iconfont_exit.css">
  <link rel="stylesheet" type="text/css" href="lte/custom/icon/font-class/iconfont_logo.css">
</head>
